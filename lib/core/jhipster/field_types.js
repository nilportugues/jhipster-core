...
const SQL_VALIDATIONS = {
  String: new Set([VALIDATIONS.UNIQUE, VALIDATIONS.REQUIRED, VALIDATIONS.MINLENGTH, VALIDATIONS.MAXLENGTH, VALIDATIONS.PATTERN]),
  Integer: new Set([VALIDATIONS.UNIQUE, VALIDATIONS.REQUIRED, VALIDATIONS.MIN, VALIDATIONS.MAX]),
  Long: new Set([VALIDATIONS.UNIQUE, VALIDATIONS.REQUIRED, VALIDATIONS.MIN, VALIDATIONS.MAX]),
  BigDecimal: new Set([VALIDATIONS.UNIQUE, VALIDATIONS.REQUIRED, VALIDATIONS.MIN, VALIDATIONS.MAX]),
  Float: new Set([VALIDATIONS.UNIQUE, VALIDATIONS.REQUIRED, VALIDATIONS.MIN, VALIDATIONS.MAX]),
  Double: new Set([VALIDATIONS.UNIQUE, VALIDATIONS.REQUIRED, VALIDATIONS.MIN, VALIDATIONS.MAX]),
  Enum: new Set([VALIDATIONS.UNIQUE, VALIDATIONS.REQUIRED]),
  Boolean: new Set([VALIDATIONS.UNIQUE, VALIDATIONS.REQUIRED]),
  LocalDate: new Set([VALIDATIONS.UNIQUE, VALIDATIONS.REQUIRED]),
  ZonedDateTime: new Set([VALIDATIONS.UNIQUE, VALIDATIONS.REQUIRED]),
  Blob: new Set([VALIDATIONS.UNIQUE, VALIDATIONS.REQUIRED, VALIDATIONS.MINBYTES, VALIDATIONS.MAXBYTES]),
  AnyBlob: new Set([VALIDATIONS.UNIQUE, VALIDATIONS.REQUIRED, VALIDATIONS.MINBYTES, VALIDATIONS.MAXBYTES]),
  ImageBlob: new Set([VALIDATIONS.UNIQUE, VALIDATIONS.REQUIRED, VALIDATIONS.MINBYTES, VALIDATIONS.MAXBYTES]),
  TextBlob: new Set([VALIDATIONS.UNIQUE, VALIDATIONS.REQUIRED, VALIDATIONS.MINBYTES, VALIDATIONS.MAXBYTES])
};
...
const CASSANDRA_VALIDATIONS = {
  ...
  Double: new Set([VALIDATIONS.UNIQUE, VALIDATIONS.REQUIRED, VALIDATIONS.MIN, VALIDATIONS.MAX]),
  Boolean: new Set([VALIDATIONS.UNIQUE, VALIDATIONS.REQUIRED]),
  Date: new Set([VALIDATIONS.UNIQUE, VALIDATIONS.REQUIRED]),
  UUID: new Set([VALIDATIONS.UNIQUE, VALIDATIONS.REQUIRED])
};
