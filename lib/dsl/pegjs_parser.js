...
(function() {
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
        ...
        peg$c138 = "unique",
        peg$c139 = peg$literalExpectation("unique", false),
        peg$c140 = function() {return {key:'unique', value:''};},
        peg$c141 = peg$otherExpectation("apostrophe"),
        peg$c142 = /^["|']/,
        peg$c143 = peg$classExpectation(["\"", "|", "'"], false, false),
        peg$c144 = peg$otherExpectation("a regular expression"),
        peg$c145 = /^[a-zA-Z0-9!@#$%\^&*()_+\-=[\]{};':\\|,.<>\/? ]/,
        peg$c146 = peg$classExpectation([["a", "z"], ["A", "Z"], ["0", "9"], "!", "@", "#", "$", "%", "^", "&", "*", "(", ")", "_", "+", "-", "=", "[", "]", "{", "}", ";", "'", ":", "\\", "|", ",", ".", "<", ">", "/", "?", " "], false, false),
        peg$c147 = function(word) {return makeString(word);},
        peg$c148 = peg$otherExpectation("an enum name"),
        peg$c149 = peg$otherExpectation("an enum property"),
        peg$c150 = /^[_]/,
        peg$c151 = peg$classExpectation(["_"], false, false),
        peg$c152 = /^[A-Z0-9]/,
        peg$c153 = peg$classExpectation([["A", "Z"], ["0", "9"]], false, false),
        peg$c154 = /^[A-Z0-9_]/,
        peg$c155 = peg$classExpectation([["A", "Z"], ["0", "9"], "_"], false, false),
        peg$c156 = function(underscore, head, tail) {
            return underscore.join('') + head + tail.join('');
          },
        peg$c157 = peg$otherExpectation("integer"),
        peg$c158 = "-",
        peg$c159 = peg$literalExpectation("-", false),
        peg$c160 = /^[0-9]/,
        peg$c161 = peg$classExpectation([["0", "9"]], false, false),
        peg$c162 = function(negative, int) {return parseInt((negative ? negative : '') + int.join(""), 10);},
        peg$c163 = peg$otherExpectation("an injected field"),
        peg$c164 = /^[a-zA-Z]/,
        peg$c165 = peg$classExpectation([["a", "z"], ["A", "Z"]], false, false),
        peg$c166 = /^[a-zA-Z0-9()]/,
        peg$c167 = peg$classExpectation([["a", "z"], ["A", "Z"], ["0", "9"], "(", ")"], false, false),
        peg$c168 = peg$otherExpectation("an entity name"),
        peg$c169 = peg$otherExpectation("a field name"),
        peg$c170 = peg$otherExpectation("a space"),
        peg$c171 = /^['\n'|'\t'|'\r'|' '|\u2028|\u2029]/,
        peg$c172 = peg$classExpectation(["'", "\n", "'", "|", "'", "\t", "'", "|", "'", "\r", "'", "|", "'", " ", "'", "|", "\u2028", "|", "\u2029"], false, false),
        peg$c173 = function(nc) {return makeString(nc);},
        peg$c174 = "/*",
        ...
        peg$c185 = function(char) {return char;},
